...
def _set_prompt_and_run(v: str):
    ...
    st.session_state["do_run"] = True
    # No st.rerun() inside callback; Streamlit reruns automatically after callback.
...
# Seed state BEFORE creating the widget; then create WITHOUT value= to avoid warning.
